...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <Navbar />
      <div className="flex-1 text-center pt-16 md:pt-20">
        ...
        <p className="text-base md:text-xl text-gray-300 max-w-3xl mx-auto px-4 pt-4 md:pt-8 font-['Manrope'] pb-12 md:pb-20">
          Your voice is important to us, and we look forward to connecting with
          you.
        </p>
      </div>
        ...
        >
          ...
          <div className="flex-1 px-5 sm:px-6 md:px-8 py-7 md:py-8">
            <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
              <input type="hidden" name="honeypot" onChange={handleChange} />
              <input
                type="text"
